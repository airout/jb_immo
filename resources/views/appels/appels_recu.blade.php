    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a class="nav-link"> <b>Liste des appels reçus</b> </a>
            </li>
        </ul>

        <ul class="navbar-nav ml-auto">
            <li class="breadcrumb-item"><a href="/projets">Accueil</a></li>
            <li class="breadcrumb-item active">Appels reçu</li>
        </ul>
        <!-- Right navbar links -->
    </nav>
            ...
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <a href="{{'/appels/supprimer_appels/' . $appel->id}}" type="submit" class="btn btn-outline-light">Supprimer</a>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
                                    ...
                                    @foreach($appels as $appel)
                                        <tr>
                                            ...
                                            <td class="project-actions text-right">
                                                ...
                                                <!-- MODIFIER -->
                                                <a class="btn btn-info btn-sm" title="Modifier"  href="{{ '/appels/recu/traiter_appel/' . $appel->id }}">
                                                    <i class="fas fa-pencil-alt">
                                                    </i>
                                                </a>
                                                <!-- SUPRIMMER

                                                <a class="btn btn-danger btn-sm" href="" title="Supprimer" data-toggle="modal" data-target="#modalDeleteClient$appel->id }}">
