    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a class="nav-link"> <b>Modifier Utilisateur</b> </a>
            </li>
        </ul>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="breadcrumb-item"><a href="/users/detail/{{$user->id}}">{{$user->name}}</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body" style="display: block;">
                        <form enctype="multipart/form-data" method="post" action="{{url('/users/update_user/'.$user->id)}}">
                            {{csrf_field()}}
                            {{ method_field('PUT')}}
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="password" class="form-control col-md-8" name="password" value="{{$user->password}}"required >
                                    </div>
